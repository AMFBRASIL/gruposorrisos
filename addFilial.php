...
<head>
    ...
    <title><?php echo APP_NAME; ?> - Nova Filial</title>
    ...
    <div class="row">
        ...
        <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="d-flex align-items-center mb-2">
                <span class="page-title"><i class="bi bi-building"></i>Nova Filial</span>
            </div>
            <div class="subtitle">Cadastre uma nova filial da empresa</div>
                            ...
                            <div class="col-12">
                                <div class="d-flex gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-check-lg me-1"></i> Salvar Filial
                                    </button>
                                </div>
                            </div>
                        </div>
...
<script src="assets/js/addFilial.js"></script>
