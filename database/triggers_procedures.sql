-- =====================================================
-- TRIGGERS E PROCEDURES - SISTEMA DE ESTOQUE GRUPO SORRISOS
-- =====================================================
...
DELIMITER //
CREATE TRIGGER IF NOT EXISTS `tr_atualizar_custo_medio` 
AFTER INSERT ON `tbl_movimentacoes`
FOR EACH ROW
BEGIN
...
DELIMITER //
CREATE TRIGGER IF NOT EXISTS `tr_atualizar_lote` 
AFTER INSERT ON `tbl_movimentacoes`
FOR EACH ROW
BEGIN
...
DELIMITER //
CREATE TRIGGER IF NOT EXISTS `tr_verificar_vencimento_lote` 
AFTER INSERT ON `tbl_movimentacoes`
FOR EACH ROW
BEGIN
...
-- Procedure para limpar alertas antigos
DELIMITER //
